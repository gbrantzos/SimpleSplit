...
{
    // Based on https://trenki2.github.io/blog/2018/12/28/activator-createinstance-faster-alternative/
    public static class InstanceFactory
    {
        private delegate object CreateDelegate(Type type, object arg1, object arg2, object arg3);

        private static readonly ConcurrentDictionary<Tuple<Type, Type, Type, Type>, CreateDelegate> cachedFuncs
        ...
        private static CreateDelegate CacheFunc(Tuple<Type, Type, Type, Type> key)
        {
            ...
            var method = typeof(InstanceFactory)
                ...
                .Single(m => m.GetParameters().Count() == 4);
